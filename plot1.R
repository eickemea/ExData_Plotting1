plot1 <- function(){
      ...
      # Generate histogram representing frequecies of Global Active Power to PNG device
      png(filename = "plot1.png")
      hist(data2$Global_active_power, xlab = "Global Active Power (kilowatts)", ylab = "Frequency", main = "Global Active Power", 
           col = "red", breaks = 12)
      dev.off()
